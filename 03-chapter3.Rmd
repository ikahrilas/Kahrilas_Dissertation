...
```{r corr-table, echo=FALSE, fig.cap=, message=FALSE}
# load packages
library(tidyverse)
library(xtable)
library(kableExtra)
...
(ref:EPN-N170-watch-topos) Topographical plots and average waveforms for N170 (160 - 200 ms; top row) and EPN (225 - 375 ms; bottom row) components during passive watch conditions. Sensors highlighted in white were used to measure N170 and EPN for waveform plots and analyses.
...
(ref:EPN-N170-pos-topos) Topographical plots and average waveforms for N170 (160 - 200 ms; top row) and EPN (225 - 375 ms; bottom row) during regulation conditions in response to positive images. Sensors highlighted in white were used to measure N170 and EPN for waveform plots and analyses.
...
(ref:EPN-N170-neg-topos) Topographical plots and average waveforms for N170 (160 - 200 ms; top row) and EPN (225 - 375 ms; bottom row) during regulation conditions in response to negative images. Sensors highlighted in white were used to measure N170 and EPN for waveform plots and analyses.
