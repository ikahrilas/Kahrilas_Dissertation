...
The EPN has been observed as a relative negative difference for stimuli as emotionally arousing/valenced compared to neutral stimuli in the 200 - 300 ms window over bilateral occipital-parietal sites [@olofssonAffectivePictureProcessing2008; @schuppAffectivePictureProcessing2000; @schuppAttentionEmotionERP2003] with potential sources residing in the occipital cortex and contributions from parietal regions [@wiensNonemotionalFeaturesSuppress2011]. For example, Yoon et al. [-@yoonEnhancedEarlyPosterior2016] found that EPN in response to happy and fearful faces were augmented compared to neutral faces among healthy controls. Further, those with anxiety disorders exhibited greater EPN in response to fearful compared to happy and neutral faces, suggesting that those with anxiety disorders may have enhanced selective attention for fearful faces [-@yoonEnhancedEarlyPosterior2016]. EPN has been observed across a variety of different tasks, inter-stimulus intervals (ISI), and stimulus presentation durations [@olofssonAffectivePictureProcessing2008], leading researchers to surmise that EPN reflects relatively automatic processes observed even when processing resources are limited due to rapid presentation rates [@junghoferFleetingImagesNew2001; @schuppAttentionEmotionERP2003; @schuppEmotionalFacilitationSensory2003]. This sensitivity may index rapid affective amygdala processing of emotionally salient information [@ledouxEmotionCluesBrain1995; @morrisConsciousUnconsciousEmotional1998] and is also theorized to indicate "natural selective attention" where evaluation of image features is contingent upon affectively arousing perceptual characteristics for additional processing [@dolcosEventrelatedPotentialsEmotional2002; @schuppSelectiveProcessingBriefly2004]. Thus, highly arousing positive and negative OASIS images may elicit greater EPN relative to neutral OASIS images.

Some research has indicated that EPN is sensitive to emotion regulation. Herbert and colleagues [-@herbertNoFearNo2013] found that EPN signals were significantly attenuated during active downregulation of emotional intensity in response to pictures of fearful faces. Such effects were not found for downregulation of emotional intensity in response to happy faces [@herbertNoFearNo2013]. Another study analyzed EPN differences among participants with low and high trait anxiety in an implicit emotion regulation task in response to pictures of faces [@liuImplicitEmotionRegulation2018]. Findings illustrated that implicit emotion regulation processing led to more significant decreases in behavioral negative emotion experience scores, and that these decreases in negative emotion experience scores were associated with enhanced EPN [@liuImplicitEmotionRegulation2018]. Lastly, these enlargements were observed for participants with low trait anxiety but not high trait anxiety, suggesting deficits in implicit emotion regulation among those with anxiety [@liuImplicitEmotionRegulation2018]. However, other research has shown that implicit emotion regulation modifies N170, but not EPN [@wangTemporalCourseImplicit2017]. 

Investigation of the relationship between EPN and explicit emotion regulation has not been thoroughly investigated, possibly due to the fact that the EPN is viewed as an index for automatic discrimination processes [@pietrekNeuromagneticIndicationDysfunctional2012]. Therefore, no hypotheses were made regarding the relationship between regulation conditions (i.e., increasing/decreasing emotional intensity in response to positive/negative images) and EPN. 
