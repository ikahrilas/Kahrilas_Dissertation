...
tab <- cor_dat %>% 
  ...
  rename("1. LPP" = LPP,
         "2. EPN" = EPN,
         "3. N170" = N170,
         "4. Arousal Ratings" = arousal,
         "5. Valence Ratings" = valence,
         "6. Difficulty Ratings" = difficulty,
         "7. PA" = pos_affectivity,
         "8. StM" = savoring_moment,
...
tab %>% 
  ...
  select(" ", everything()) %>% 
## create table
kable(., format = "latex",  linesep = "", escape = FALSE, booktabs = TRUE, align = c("l", rep("r", 9)), caption = "(ref:corr-table)") %>% 
