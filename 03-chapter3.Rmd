...
Our experimental paradigm included 120 different standardized complex affective stimuli (40 positive, 40 neutral, and 40 positive) from the Open Affective Standardized Image Set [OASIS; @kurdiIntroducingOpenAffective2017].
...
The study used 120 different OASIS images [@kurdiIntroducingOpenAffective2017].
...
During the emotion task, participants viewed seven blocks of 40 images (280 total trials). Forty of the images were positive, 40 were neutral, and 40 were negative. 
...
EEG data were re-referenced to the average reference of all electrodes for analyses and digitally filtered with 0.01 Hz high-pass and 30 Hz low-pass filters with a cutoff attenuation of 12 dB/octave [@hajcakAttendingAffectAppraisal2006; @hajcakReappraisalModulatesElectrocortical2006].
...
conditions, differences among passive viewing and increase (positive and negative) conditions were generally observed.
...
(ref:rm-anova-tab) Repeated Measures ANOVA Results with Block as the Independent Variable for Each Extracted ERP Component from the PCA and Behavioral Ratings as Dependent Variables (n = 54).
...
Small effects were noted between increase and watch conditions for positive and negative regulatory conditions, with more negative amplitudes in the increase relative to watch conditions.
