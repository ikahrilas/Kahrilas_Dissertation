...
<!-- Further, we surmised that higher self-report ratings of one’s capacity to savor would be expected to moderate the relationship between LPP and increased emotional intensity in response to positive stimuli. -->
...
Our objective was to examine how block type would influence ERP components using an exploratory PCA approach.
We expected that highly arousing positive and negative compared to neutral Open Affective Standardized Image Set (OASIS) stimuli would be associated with enhanced ERP components retained from the PCA (e.g., N170, EPN, LPP).
...
## DISCUSSION
We aimed to explore the neural time course of positive and negative emotion reactivity and regulation with an exploratory temporal PCA approach in the present study.
...
Of note, no component resembling N170 was retained in our temporal PCA. 
It may be that our block design paradigm or use of complex affective stimuli failed to capture these components.

Passively viewing positive and negative OASIS stimuli elicited augmented amplitude compared to neutral images across both LPP components and a positive component with a 162 ms peak.
...
However, these results did align with Wilson and MacNamara (2021), who adopted a novel paradigm that instructed participants to savor positive IAPS stimuli, with language borrowed from Bryant's [@bryantFourfactorModelPerceived1989; @bryantSavoringNewModel2007] conceptualization of savoring.
This condition is most similar to our positive increase condition (see supplementary materials for instructions used in the present experiment).
Notably, our instructions prompted participants to reappraise the images in a manner that elicited greater emotional intensity, while Wilson and MacNamara were careful not to adopt such language on the basis that the cognitive demands of reappraisal may actually contradict the goal of increasing emotional intensity.
...
No positive increase effect was observed for the 740 ms LPP component, though the positive increase condition did elicit an augmented amplitude when compared with the positive decrease condition.
...
While we have done our best to adhere to open science principles, hypotheses were not preregistered due to continued iteration of the study to employ novel methods (i.e., PCA) to more adequately answer our questions.
...
Findings illustrated that early and slow wave ERP components may be selectively enhanced in response to viewing and upregulating positive emotion and negative emotion. 
Additionally, future aims have been identified based on these findings, such as examining relations among self-report data and ERP data, recruiting a more diverse sample, and utilizing different EEG methods (e.g., source analysis, time frequency analysis).
...
Regardless of these limitations, the present study brings attention to a more holistic perspective of the time course of positive and negative emotion reactivity/regulation.
Past research on affective processing has overwhelmingly focused on negative emotion.
This work is useful for mitigating the effects of unpleasant emotion and bolstering positive emotion.
Uncovering the biological implementations of emotion reactivity and regulation will be crucial for developing therapeutic and pharmacological interventions for those suffering from psychological and physiological ailments.
