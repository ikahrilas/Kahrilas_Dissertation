...
Each analysis resulted in a significant test statistic at $\alpha = .05$, signifying that block type accounted for a significant portion of the variance in each fo the retained ERP components and behavioral ratings. 
...
Regarding behavioral ratings, we observed differences in arousal and valence ratings among passive watch conditions.
In terms of regulation conditions, differences among passive viewing and increase conditions were noted in general.
Statistical results for EEG components are summarized in Figure \@ref(fig:bx-contrast-plot), and more detailed statistical findings for each comparison are provided in Appendix A of the supplementary materials.
...
On average, participants rated negative images more negatively than neutral images and positive images and more positively than than neutral images.
In terms of positive regulation conditions, medium sized differences in arousal ratings were observed when comparing increase and watch conditions, as well as large differences between increase and decrease conditions. 
...
In devising neuroscience-informed interventions, targeting reactivity, positive emotion regulation, or negative emotion regulation may have important implications in terms of modifiable neural correlates.
...
No previous studies have investigated components this early in the neural time course of emotion processing in response to complex affective images, though this pattern of findings largely fits with research investigating later slow wave components [i.e., enhanced amplitude for emotional stimuli, with greater effects for negative stimuli, e.g., @fotiDifferentiatingNeuralResponses2009; @frankHemodynamicElectrocorticalReactivity2019].
...
Emotion regulation, on the other hand, may require a more selective approach in identifying modifiaable neural correlates
...
Another study conducted in our lab (Kahrilas et al., in prep) suggests that positive reactivity in this component is related to positive affectivity (i.e., one's disposition to experience positive emotions), which shows specificity to depression [@clarkTripartiteModelAnxiety1991].
...
To the authors' knowledge, this is the first display of explicit regulatory effects in at this time point, ultimately implying that early visual ERP processes may play a larger role in emotion regulation than previously surmised.
...
With regards to reactivity, it appears that the 162 ms, 381 ms, and 740 ms component mapped onto behavioral ratings of valence and arousal.
More specifically, these components appear to be related to state mood manipulations following each experimental block.
