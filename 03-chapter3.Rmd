...
Given the limited research on explicit emotion regulation and EPN/N170, no hypotheses were made regarding the relationship among regulation conditions (i.e., increasing/decreasing emotional intensity in response to positive/negative images) and N170/EPN.
...
Thus, the LPP is sensitive to the arousal and valence of emotional stimuli.
...
Higher self-report ratings of one’s capacity to savor, then, would be expected to moderate the relationship between LPP and increased emotional intensity in response to positive stimuli.
...
The first objective was to examine how block type would influence ERP components using a PCA approach.
We hypothesized that highly arousing positive and negative compared to neutral OASIS stimuli would be associated with enhanced ERP components (N170, EPN, LPP).
Related, we hypothesized reduction of LPP in decrease conditions relative to passive watch conditions, and increased LPP in increase relative to passive watch conditions.
No a priori hypotheses regarding ERP/N170 and regulation were made.
The second objective was to examine the relation between personality traits and EEG components.
We predicted that a) PA would moderate the relationship between watching positive images and LPP and b) savoring capacity would moderate the relationship between increasing emotional intensity in response to positive images and LPP. 
No hypotheses were made regarding personality traits and N170/EPN.
