...
(ref:LPP-neg-topos) Topographical plots and average waveforms for N170 (top row) and EPN (bottom row) during regulation conditions in response to positive images. Sensors highlighted in white were used to measure N170 and EPN for waveform plots and analyses.
