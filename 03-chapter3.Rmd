...
EEG components of interest thus far have focused on the *implementation* emotion regulatory stage. To fully appreciate the temporal dynamics of emotion regulation a type of slow cortical potential observed at fronto-central sites, the stimulus-preceeding negativity (SPN), was also examined. The SPN is theorized to index orienting, preparatory, and anticipatory processes that are enhanced prior to regulatory tasks compared to non-regulatory tasks (e.g., passively watching vs. reappraising emotional stimuli; @linLargerN2Smaller2014; @shafirEmotionalIntensityInfluences2015). SPN, also known as the contingent negative variation (CNV), has been observed preceding affective stimuli [@linLargerN2Smaller2014] and is selectively enhanced when preparing to reappraise negative stimuli compared to passively viewing negatively and neutrally-valenced affective stimuli [@moserElectrophysiologicalCorrelatesDecreasing2009; @shafirEmotionalIntensityInfluences2015; @thiruchselvamTemporalDynamicsEmotion2011]. These effects have not been observed when preparing to increase emotional intensity in response to negative stimuli [@moserElectrophysiologicalCorrelatesDecreasing2009]. In line with previous research, it was hypothesized that augmented SPN would be observed for decrease conditions. Past literature has shown a relationship between enhanced SPN and trait worry in anticipation of positively reappraising unpleasant stimuli, suggesting that worriers engage in more preparatory processes that are ultimately ineffective to the end of regulating one's emotions [@moserNeuralMarkersPositive2014]. Anticipating, the future-oriented temporal domain of savoring, can be seen a positive analogue to worry, as the latter is characterized by preparation and expectation the worst [@moserNeuralMarkersPositive2014] while the former indexes one capacity to look forward to positive outcomes [@bryantSavoringBeliefsInventory2003a; @bryantSavoringNewModel2007]. Thus, it was hypothesized that SPN while increasing emotional intensity in response to positive images compared to passively watching positive images would vary as a function of one's ability to anticipate future positive events.

Other exploratory analyses will focus on characterizing the relationship between behavioral ratings for emotional valence (negative to positive), emotional intensity (not arousing to highly arousing), regulatory blocks, and personality trait measures (PA and savoring capacity). Research has demonstrated that highly arousing positively- and negatively-valenced images are associated with heightened behavioral ratings [@bradleyInternationalAffectivePicture2007; @kurdiIntroducingOpenAffective2017]. Thus, it is hypothesized that passively viewing negative and positive images compared to neutral images will result in heightened arousal ratings, as well as decreased (for negative images) and increase (for positive images) valence ratings. Further, it is expected that regulation conditions will result in behavioral ratings consonant with the regulatory goal; arousal ratings will be heightened for increase conditions and lowered for decrease conditions and valence ratings will be closer to the midpoint (neutral) for decrease conditions and farther away from the midpoint for increase conditions. Last, trait measures of PA and savoring capacity are associated with heightened reactivity and more positive affect [@bryantSavoringNewModel2007; @watsonPositiveAffectivity2009]. Thus, it was hypothesized that the difference in behavioral/valence ratings between  passively watching positive vs. neutral images would be positively moderated by PA and the difference in behavioral/valence ratings between increasing emotional intensity in response to positive images vs. passively watching positive images would be positive moderated by savoring capacity.
...
Exploratory analyses indicated that other earlier EEG components, the N170 and EPN, were also modulated depending on the valence of visual stimuli. While it was predicted that more arousing images would be associated with enhanced negativity of these components, the present study yielded findings in the opposite direction (i.e., more positive N170 and EPN components for negative and positive compared to neutral images). This is in contrast to past research utilizing complex image sets (IAPS) illustrating enhanced negativity in these components [e.g., @frankHemodynamicElectrocorticalReactivity2019; @schuppAttentionEmotionERP2003]. This may be attributed to the present study's use of a block design paradigm where neural signals may partly reflect aggregated mood effects over the course of each experimental block, which is underscored by correlations among these early components and behavioral arousal ratings. It is also possible that there are concomitant slow frequency components contributing to manifest waveforms. Future research should consider time-frequency and source analysis analysis to disentangle constituent components neutral source generators. 

Comparisons among regulation conditions did not show significant differences between increase and decrease conditions in SPN, N170, LPP, or late LPP for positive or negative images. This diverges from previous findings showing a reduction in LPP for when decreasing emotional intensity in response to negative and positive images [@krompingerModulationsElectrophysiologicalResponse2008; @moserElectrophysiologicalCorrelatesDecreasing2009; @moserIntentionalModulationEmotional2006; @moserNeuralMarkersPositive2014] and from research showing enhanced negativity in SPN in preparation for decrease conditions [@moserElectrophysiologicalCorrelatesDecreasing2009]. The present study's utilization of a block design with a relatively large number of regulation trials may have resulted in a reduction in LPP activity over the course of each block due to habituation effects and declines in attention allocation [@codispotiRepetitivePictureProcessing2006]. Additionally, the present experimental is not optimized for measurement of SPN due to relatively short ISIs compared to other studies that have found significant effects. The lack of a significant increase effect on LPP for positive and negative images has been found elsewhere [@krompingerModulationsElectrophysiologicalResponse2008; @moserElectrophysiologicalCorrelatesDecreasing2009]. This may be due to a theorized ceiling effect reported by Moser (2008) and Krompinger (2009) that results from automatic capture of attentional resources by motivationally relevant stimuli and the fact that the present study was underpowered to observe small effects. Interestingly, the EPN was significantly increased for increase compared to watch conditions for positive, but not negative, images. Of note, observed EPN effects were in the opposite direction than what would normally be hypothesized (i.e., enhanced negativity). This suggests possible differences in the neural time course of regulating positive compared to negative emotions and underscores the importance of investigating the entire time course of neural affective processing. However, these hypotheses were not preregistered and should be interpreted with caution. It is prudent that future researchers make a priori hypotheses regarding these earlier components' relationship to positive emotion. 

Findings for behavioral valence and arousal ratings in regulation conditions supported our hypotheses. Increasing and decreasing emotional intensity in response to positive and negative stimuli resulted in increased and decreased arousal/valence ratings compared to passively watching, respectively. This indicates that while the experiment was unsuccessful in manipulating EEG components via regulation conditions, it was successful in producing state mood manipulations that were commensurate with participants' regulatory goal. Thus physiological and behavioral measures may be indexing overlapping, yet distinct, processes.  Future research utilizing similar experimental paradigms would benefit from collecting behavioral data in addition to physiological measure to further elucidate their relationship.

Evidence of conditional relationships between regulating one’s emotion in response to affective images and EEG components as a function of personality traits pertaining to positive emotion was not found. This is a departure from earlier fMRI research investigating correlations between neural activation in response to pleasant stimuli/happy faces and the personality trait of extraversion [@canliAmygdalaResponseHappy2002; @canliFMRIStudyPersonality2001]. This discrepancy could be due to different methods. Canli et al. (2001, 2002) utilized fMRI and presented five blocks of four pictures that were presented for 7.5 seconds each while the present study used EEG and utilized seven blocks of 40 image blocks that were presented for two seconds each. fMRI does not have the temporal resolution necessary to analyze timing in the 0 – 3000 ms time window as the present study did. Thus, it is possible that different components were being analyzed in Canli et al. (2001, 2002) and the present study. Furthermore, Canli et al. (2001) limited their sample to only women on the grounds that, “...they are more likely to report intense emotional experiences (Shields, 1991) and because they show more physiological reactivity in concordance with valence judgments than men (Lang, Greenwald, Bradley, & Hamm, 1993).” In contrast, the present study recruited participants regardless of gender to facilitate generalizability. Of note, a significant moderating effect of PA was found when analyzing difference in behavioral valence scores between passively viewing positive vs. neutral images, such that those reporting higher levels of PA tended to endorse more positive state mood manipulations after passively viewing the positive image block. This suggests that PA may be a viable clinical intervention target for those with mood disorders, such as depression, which is marked by a negative emotional disposition [@beckCognitiveTherapyEmotional1979] and is further supported by research suggesting that positive emotions are as important an intervention target as negative emotions in treating depression [@demyttenaereWhatImportantBeing2015; @dunnChangesPositiveNegative2019].

There several limitations to the present study. The psychophysiological data collected are cross-sectional and causation cannot be inferred. While we have done our best to adhere to open science principles, some hypotheses were not preregistered. Further, software used for EEG reduction is closed source (BESA; Scherg & Berg, 1990). While we are unable to share materials or code that can replicate our data reduction analyses, we have provided step-by-step instructions that were used for data reduction. Lastly, the present study’s exclusionary criteria (only recruited participants who were right-handed, not color-blind, and learned English as a first language) and reliance on a convenience sample mostly comprised of Caucasian college students limits ability to generalize findings to a more diverse population. Future research should investigate the neural correlates of positive emotion regulation in more diverse samples. Much research on this topic (the present study included) relies on convenience samples [e.g., @hajcakReappraisalModulatesElectrocortical2006; @kimNeuralCorrelatesPositive2007; @moserIntentionalModulationEmotional2006]. Last, the experimental paradigm utilized was not optimal for elicitation of pre-stimulus SCPs, such as SNP, which is typically measured using longer ISIs in non-blocked designs [e.g., @moserNeuralMarkersPositive2014].  
