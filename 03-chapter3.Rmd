...
kable(., "latex", escape = FALSE, booktabs = TRUE, align = c("l", "c", "c", "c"), linesep = "", caption = "(ref:pairwise-watch-comparison-table)") %>% 
  ...
  footnote(escape = FALSE,
           footnote_as_chunk = TRUE,
           general_title = "Note.",
           general = "Std. Beta (Label) = Standardized Beta coefficient as measure of effect size derived by fitting model to standardized dataset with effect size label as per Funder's (2019) recommendations, Sig. = $p$ value. $P$ values and confidence intervals adjusted using the Tukey method for comparing a family of three estimates.",
           threeparttable = TRUE) %>% 
  save_kable("poop.png")
```
...
reg_tab <- reg_tab %>% 
  ...
  mutate("Estimate (95\\% CI)" = paste0(Estimate, " (", CI, ")"),
         "Std. Beta (Label)" = paste0(reg_tab$`Std. Beta`, " (", interpretation, ")")) %>% 
...
kable(., "latex", escape = FALSE, booktabs = TRUE, align = c("l", rep("c", times = 6)), linesep = "", caption = "(ref:pairwise-reg-comparison-table)") %>% 
  ...
  footnote(escape = FALSE,
           general_title = "Note.",
           general = "Std. Beta = Standardized Beta coefficient as measure of effect size derived by fitting model to standardized dataset with effect size label as per Funder's (2019) recommendations, Sig. = $p$ value. $P$ values and confidence intervals adjusted using the Tukey method for comparing a family of three estimates.",
           threeparttable = TRUE,
           footnote_as_chunk = TRUE) %>% 
  save_kable("poop.jpg")
```
