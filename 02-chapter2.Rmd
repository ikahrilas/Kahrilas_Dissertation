...
(ref:path-analysis-table) Unstandardized path coefficients from the structural equation model using positive and negative affectivity to predict depression with savoring subscales as mediators (N = 1,618). The structural model included three covariates (sex, worry, and anxious arousal) as exogenous independent variables, each of which had direct effects on the three mediators and depression.
